(function (global) {
    ...
    var oproto = Object.prototype, aproto = Array.prototype, doc = global.document, keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", $ = {
        hasOwn: function (obj, prop) {
            ...
            return {
                isIE: isIE, isIE11: isIE && ieVersion == 11, isIE10: isIE && ieVersion == 10, isIE9: isIE && ieVersion == 9, isIE8: isIE && ieVersion == 8, isIE7: isIE && ieVersion == 7, isIE6: isIE && ieVersion == 6, ieVersion: ieVersion, isWebkit: isWebkit, isChrome: isChrome, isChromeFrame: isChrome && typeof global.externalHost != "undefined", isChromium: isChromium, isSafari: isSafari, isSafari3: isSafari && ua.indexOf("Version/3") != -1, isSafariIpad: isWebkit && ua.indexOf("iPad") != -1, isSafariIOS: isSafari &&
            ...
            var defaults = {
                method: "GET", async: true, beforerequest: function () {
                    return true
                }, success: function () {
                }, failure: function () {
                }, complete: function () {
